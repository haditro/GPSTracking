...
public class KalmanFilter {
    ...
    public KalmanFilter(Matrix X, Matrix P, Matrix H, Matrix R)
    {
        this.X = X;
        this.P = P;
        this.H = H;
    ...
    public KalmanFilter timeUpdate(Matrix A, Matrix Q, Matrix Ga)
    {
        //  Matrix Ax = A.times(X);
        X = (A.times(X)).plus(Ga);
     ...
     * @return
     */
    public Matrix measurementUpdate(Matrix Xk)
    {
        // compute kalman gain
